...
from if_drone_control.srv import *
import rospy
import rosservice
...
from   if_drone_control.msg  import quad_pose
...
if __name__ == "__main__":
    ...
    s = rospy.Service('altitude_service', altitude, handle_req)
    #rate.sleep()
    rospy.spin() 
